...
void Touch_Plat_Center( edict_t *ent, edict_t *other, cplane_t *plane /* unused */,
...
void button_killed( edict_t *self, edict_t *inflictor /* unused */, edict_t *attacker /* unsued */,
...
void Touch_DoorTrigger( edict_t *self, edict_t *other, cplane_t *plane /* unused */,
                   csurface_t *surf /* unused */ ) {
...
void door_killed( edict_t *self, edict_t *inflictor /* unused */, edict_t *attacker,
             int damage /* unused */, vec3_t point /* unused */ ) {
	edict_t *ent;
...
void door_secret_die( edict_t *self, edict_t *inflictor /* unused */, edict_t *attacker,
                 int damage /* unused */, vec3_t point /* unused */ ) {
	if ( !self || !attacker ) {
		return;
	}
